...
import { ArrowRight, Megaphone, CheckCircle2, Target, TrendingUp, BarChart, Zap, Award, Users, Globe, Clock, Heart, Star, Rocket, DollarSign } from "lucide-react";
import { Button } from "@/components/Button";

export const GoogleMataAds = () => {
    ...
    const features = [
        { icon: Target, title: "Precise Targeting", desc: "Reach your ideal customers with laser precision" },
        { icon: DollarSign, title: "Budget Optimization", desc: "Maximize ROI with smart budget allocation" },
        { icon: BarChart, title: "Performance Tracking", desc: "Real-time analytics and reporting" },
        { icon: Zap, title: "Quick Results", desc: "Start generating leads within days" },
        { icon: TrendingUp, title: "Conversion Optimization", desc: "A/B testing and landing page optimization" },
        { icon: Award, title: "Expert Management", desc: "Certified Google & Meta Ads specialists" }
    ];

    const stats = [
        { value: "250+", label: "Ad Campaigns", icon: Rocket },
        { value: "200%", label: "Avg ROI", icon: TrendingUp },
        { value: "50k+", label: "Leads Generated", icon: Users },
        { value: "95%", label: "Client Retention", icon: Star }
    ];
        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10">
                    <div className="text-center space-y-6">
                        <span className="text-[#4a90e2] font-bold tracking-widest uppercase text-sm bg-[#4a90e2]/10 px-6 py-2 rounded-full border border-[#4a90e2]/20 inline-block animate-glow">Paid Advertising</span>
                        <h1 className="text-5xl md:text-7xl font-black text-white leading-tight">
                            Google / Meta<br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4a90e2] via-[#00d28d] to-[#4a90e2] animate-gradient">Ads</span>
                        </h1>
            ...
            <section className="py-20 bg-gradient-to-b from-[#111]/50 to-[#0a0a0a]">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <span className="text-[#4a90e2] font-bold tracking-wider uppercase text-sm animate-glow">Ad Management</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-white mt-4">ROI-Focused Advertising</h2>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-r from-[#4a90e2] to-[#00d28d] animate-gradient">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-white/90 text-xl mb-8">Start generating quality leads with paid ads</p>
